...
import grpc_code_gen.hello.GreeterGrpc.getServiceDescriptor
...
public object GreeterGrpcKt {
  ...
  public val sayHelloMethod: MethodDescriptor<Hello.HelloRequest, Hello.HelloReply>
    @JvmStatic
  ...
  public class GreeterCoroutineStub @JvmOverloads constructor(
     ...
     */
    public suspend fun sayHello(request: Hello.HelloRequest, headers: Metadata = Metadata()):
        Hello.HelloReply = unaryRpc(
      channel,
  ...
  public abstract class GreeterCoroutineImplBase(
     ...
     */
    public open suspend fun sayHello(request: Hello.HelloRequest): Hello.HelloReply = throw
